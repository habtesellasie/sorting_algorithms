 ...
 * Return: Positive byte difference or 0
 */
...
/**
 * insertion_sort_deck_value - A funciton to sort a deck of cards
 * @deck: A pointer to the head of a deck_node_t doubly-linked list
 */
...
/**
 * sort_deck - A function to sort a deck of cards from ace to king
 * @deck: A pointer to the head of a deck_node_t doubly-linked list
 */
